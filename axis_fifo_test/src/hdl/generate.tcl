...
if {$argc != 5} {
	...
	set project_build_dir [lindex $argv 1]
	set ip_dir [lindex $argv 2]
	set sources_dir [lindex $argv 3]
...
# project directory
set build_project_dir [concat_str $project_build_dir / $project_name]

# project build sources directory
set build_sources_dir [concat_str $build_project_dir / $project_name .srcs/sources_1]

# project build constraints directory
set build_constrs_dir [concat_str $build_project_dir / $project_name .srcs/constrs_1]
...
# add constraints
file mkdir $build_constrs_dir
file copy [concat_str $sources_dir /constraints.xdc] $build_constrs_dir
add_files -fileset constrs_1 -norecurse [concat_str $build_constrs_dir /constraints.xdc]

create_bd_design $project_name

# run write_bd_tcl <file> to generate this from vivado GUI
...
set_property -dict [ list \
 ...
 CONFIG.C_TX_FIFO_PE_THRESHOLD {512} \
 CONFIG.C_TX_FIFO_PF_THRESHOLD {32763} \
...
connect_bd_intf_net -intf_net axi_fifo_mm_s_0_AXI_STR_TXD [get_bd_intf_pins axi_fifo_mm_s_0/AXI_STR_TXD] [get_bd_intf_pins axi_fifo_mm_s_1/AXI_STR_RXD]
...
connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_fifo_mm_s_0/s_axi_aclk] [get_bd_pins axi_fifo_mm_s_1/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_fifo_mm_s_0/s_axi_aresetn] [get_bd_pins axi_fifo_mm_s_1/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
...
# create HDL wrapper
make_wrapper -files [get_files [concat_str $build_sources_dir /bd/ $project_name / $project_name .bd]] -top
add_files -norecurse [concat_str $build_sources_dir /bd/ $project_name /hdl/ $project_name _wrapper.v]
